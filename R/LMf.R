...
#' @param tw A list of time point options, including landmark time points (sl) and prediction windows (w).
...
#' @param time Individual's survival time column name
#' @param status Individual's survival status column name
#' @param inter Indicator variables: whether covariates in the model need to include dynamic effects, with the default being TRUE.
