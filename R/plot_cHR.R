...
#' @param conf_int Indicator variable. It indicates whether confidence intervals are included, with the default being TRUE.
#' @param IDlegend Label of the plot, with the default being NULL.
#' @param legend Annotations or descriptions of the plot, with the default being NULL.
#' @param xlab Label of the horizontal axis, with the default being "landmark time points(s)".
#' @param ylab Label of the vertical axis, with the default being "Dynamic HR (w=5)".
#' @param ylim The scale range of the vertical axis is, by default, from the minimum to the maximum value of effect size of the covariate.
...
#' plot_cHR(a1,c("age"),conf_int=TRUE,IDlegend="a.",legend="(Per 10 years)",xlab="landmark time points(s)",ylab="Dynamic HR (w=5)")
